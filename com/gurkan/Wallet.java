...
import com.gurkan.transaction.TransactionInput;
import com.gurkan.transaction.TransactionOutput;
import com.gurkan.transaction.Transactions;
...
public class Wallet {
    ...
    public float getBalance() {
        float total = 0;
        for (Map.Entry<String, TransactionOutput> item: transactions.UTXOs.entrySet()){
